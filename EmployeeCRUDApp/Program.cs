...
namespace EmployeeCRUDApp
{
    class Program
    {
        ...
        static void CreateEmployee(SqliteConnection connection)
        {
            ...
            string insertQuery =
                "INSERT INTO Employees (FirstName, LastName, DateOfBirth) VALUES (@FirstName, @LastName, @DateOfBirth)";
        ...
        static void ListEmployees(SqliteConnection connection)
        {
            ...
            using (var reader = command.ExecuteReader())
            {
                ...
                {
                    Console.WriteLine(
                        $"ID: {reader["EmployeeID"]}, Name: {reader["FirstName"]} {reader["LastName"]}, DOB: {reader["DateOfBirth"]}"
                    );
                }
            }
        }
